 ...
 * @property {string} id - Motif ID
 * @property {string} name - Motif name
 * @property {string} [artist] - Artist name
 * @property {string} instrument - Instrument
 * @property {string} scale - Musical scale
 * @property {string[]} tags - Tags
 * @property {number} measures - Number of measures
 * @property {MusicalNote[]} notes - Musical notes
 * @property {Object.<string, *>} [metadata] - Additional metadata
 */

/**
 * @typedef {Object} MotifSearchOptions
 * @property {string} [artist] - Artist filter
 * @property {string} [instrument] - Instrument filter
 * @property {string} [scale] - Scale filter
 * @property {string} [tag] - Tag filter
 * @property {number} [minMeasures] - Minimum measures
 * @property {number} [maxMeasures] - Maximum measures
 */
