...
exports.FractalVisualizer = void 0;
const PlotRenderer_1 = require("../plots/PlotRenderer");
class FractalVisualizer {
    ...
    static plotLogisticMap(rMin = 2.8, rMax = 4.0, rSteps = 1000, iterations = 1000, skipTransient = 500, options = {}) {
        ...
        return PlotRenderer_1.PlotRenderer.scatter(data, {
            title,
            width,
            height,
            showAxis: true
    ...
    static plotMandelbrot(xMin = -2.5, xMax = 1.0, yMin = -1.25, yMax = 1.25, resolution = 400, maxIterations = 100, options = {}) {
        ...
        return PlotRenderer_1.PlotRenderer.heatmap(matrix, {
            title,
            width,
            height,
            showAxis: false
    ...
    static plotFractalDimension(data, options = {}) {
        ...
        return PlotRenderer_1.PlotRenderer.line(plotData, {
            title,
            width,
            height,
            showAxis: true
    ...
    static plotPhaseSpace(data, delay = 1, embedding = 2, options = {}) {
        ...
        return PlotRenderer_1.PlotRenderer.scatter(plotData, {
            title,
            width,
            height,
            showAxis: true
...
//# sourceMappingURL=FractalVisualizer.js.map