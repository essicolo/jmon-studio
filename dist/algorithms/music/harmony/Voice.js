...
/**
 * @typedef {Object} VoicingOptions
 * @property {number} [voiceCount] - Number of voices
 * @property {[number, number]} [voiceRange] - Voice range
 * @property {[number, number]} [intervalLimits] - Interval limits
 * @property {boolean} [doubling] - Allow doubling
 * @property {number} [inversion] - Inversion
 */

/**
 * @typedef {Object} ChordVoicing
 * @property {number[]} notes - Chord notes
 * @property {number} root - Root note
 * @property {string} quality - Chord quality
 * @property {number} inversion - Inversion
 */
