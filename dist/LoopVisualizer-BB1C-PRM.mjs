...
class E {
   ...
   */
  static async plotLoops(l, r = 4, t = 1 / 4, a = null, e = {}) {
    const {
    ...
    const v = this.generateTickValues(r, t), x = this.generateTickLabels(r, t), V = c.map((h) => h.label), $ = {
      title: { text: g },
      polar: {
        radialaxis: {
          visible: !0,
   ...
   */
  static generateColors(l, r = "colorblind") {
    const t = [];
    switch (r) {
      case "colorblind":
        const a = [
   ...
   */
  static hsvToRgb(l, r, t) {
    let a, e, o;
    const g = Math.floor(l * 6), s = l * 6 - g, n = t * (1 - r), f = t * (1 - s * r), b = t * (1 - (1 - s) * r);
    switch (g % 6) {
      case 0:
        a = t, e = b, o = n;
        break;
   ...
   */
  static generateArcPoints(l, r, t) {
    const a = [];
    for (let e = 0; e < t; e++) {
      const o = l + e / (t - 1) * r;
      a.push(o % 360);
   ...
   */
  static generateTickValues(l, r) {
    const t = [], a = Math.floor(l / r);
    for (let e = 0; e < a; e++)
      t.push(e * 360 / a);
    return t;
  }
