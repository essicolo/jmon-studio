...
export class Scale {
   ...
   */
  async plotScale(octave = 4, length = 8, options) {
    const { PlotRenderer } = await import('../../visualization/plots/PlotRenderer.js');
    const pitches = this.generate(octave, length);
