...
export class Polyloop {
   ...
   */
  async plot(options) {
    const { PolyloopVisualizer } = await import('../../visualization/polyloops/PolyloopVisualizer.js');
   ...
   */
  async plotTimeline(duration = 8, options) {
    const { PolyloopVisualizer } = await import('../../visualization/polyloops/PolyloopVisualizer.js');
   ...
   */
  async plotAnimated(numFrames = 12, options) {
    const { PolyloopVisualizer } = await import('../../visualization/polyloops/PolyloopVisualizer.js');
