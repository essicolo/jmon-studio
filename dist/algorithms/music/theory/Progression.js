...
class Progression {
    constructor(tonic, mode = 'major') {
        this.scale = new Scale_1.Scale(tonic, mode);
    }
    generate(options = {}) {
            ...
            if (strumPattern) {
                ...
                chordPitches.forEach((pitch, noteIndex) => {
                    notes.push({
                        ...
                        time: conversion_1.JMonConverter.timeToMusicalTime(chordIndex + noteIndex * 0.1),
                        duration: '8n',
                ...
                // Play chord as block
                notes.push({
                    note: chordPitches.map(pitch => conversion_1.JMonConverter.midiToNoteName(pitch)),
                    time: conversion_1.JMonConverter.timeToMusicalTime(chordIndex),
                    duration,
                    velocity
                });
            }
