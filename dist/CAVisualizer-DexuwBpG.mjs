...
async function m() {
  ...
  try {
    if (typeof window < "u" && window.Plotly)
      return u = window.Plotly, u;
    if (typeof window > "u") {
      const t = await import("plotly.js");
      return u = t.default || t, u;
    }
    return null;
  } catch {
...
class p {
  ...
  static async line(t, i = {}, a = "plot") {
    ...
    await e.newPlot(a, [y], x);
  }
  /**
   * Create a scatter plot
   */
  static async scatter(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
    ...
    await plotly.newPlot(a, [r], y);
  }
  /**
   * Create a heatmap from 2D matrix data
   */
  static async heatmap(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   */
  static async radar(t, i = {}, a = "plot") {
    const { title: e, width: n = 400, height: o = 400, color: s = "steelblue" } = i, l = [...t.x, t.x[0]], r = {
      r: [...t.y, t.y[0]],
      theta: l,
      type: "scatterpolar",
      mode: "lines+markers",
   ...
   */
  static async timeSeries(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
    ...
    await plotly.newPlot(a, [c], r);
  }
  /**
   * Create a matrix visualization (for cellular automata)
   */
  static async matrix(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   */
  static async surface(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
    ...
    await plotly.newPlot(a, [y], x);
  }
  /**
   * Create multiple line plot
   */
  static async multiLine(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   * Create histogram
   */
  static async histogram(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   * Create box plot
   */
  static async boxPlot(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
    ...
    await plotly.newPlot(a, l, c);
  }
  /**
   * Create a violin plot
   */
  static async violin(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   */
  static async contour(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   */
  static async scatter3D(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
   ...
   */
  static async animate(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
    ...
    await u.newPlot(a, c, r), await plotly.addFrames(a, y);
  }
  /**
   * Create candlestick chart
   */
  static async candlestick(t, i = {}, a = "plot") {
    const {
      title: e,
      width: n = 640,
      height: o = 400,
...
class f {
  ...
  static plotEvolution(t, i = {}) {
    const {
      title: a = "Cellular Automata Evolution",
      width: e = 600,
      height: n = 400,
      colorScheme: o = "binary",
      showAxis: s = !1
    } = i, l = [];
  ...
  static compareRules(t, i = {}) {
    ...
    return t.map(
      ({ ruleNumber: o, history: s }) => this.plotEvolution(s, {
        title: `Rule ${o}`,
        width: a,
        height: e,
        colorScheme: n,
  ...
  static extractPatterns(t) {
    const i = [], a = [], e = [], n = t[0]?.length || 0;
    for (let o = 0; o < n; o++) {
      const s = t.map((c) => c[o]), l = this.findPeriod(s.filter((c) => c !== void 0));
      l > 1 && l < 10 && i.push({ position: o, period: l });
    }
    if (t.length > 5) {
    ...
    return { oscillators: i, gliders: a, stillLifes: e };
  }
  /**
