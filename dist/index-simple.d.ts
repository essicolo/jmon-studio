...
export declare const dj: {
    ...
    MotifBank: typeof MotifBank;
    GaussianProcess: typeof GaussianProcessRegressor;
    CellularAutomata: typeof CellularAutomata;
    Polyloop: typeof Polyloop;
    GeneticAlgorithm: typeof GeneticAlgorithm;
    RandomWalk: typeof RandomWalk;
    Fractals: {
        Mandelbrot: typeof Mandelbrot;
        LogisticMap: typeof LogisticMap;
    };
    MinimalismProcess: typeof MinimalismProcess;
};
