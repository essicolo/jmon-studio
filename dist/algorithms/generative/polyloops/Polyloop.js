    ...
    toJMonSequences(duration = 4) {
        ...
        sequencesByLayer.forEach((layerTriggers, layerName) => {
            const notes = layerTriggers.map(trigger => ({
                note: conversion_1.JMonConverter.midiToNoteName(trigger.point.pitch || 60),
                time: conversion_1.JMonConverter.timeToMusicalTime(trigger.time),
...
//# sourceMappingURL=Polyloop.js.map